...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ app)\n/* harmony export */ });\n/* harmony import */ var _factories_player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./factories/player */ \"./src/factories/player.js\");\n/* harmony import */ var _factories_gameboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./factories/gameboard */ \"./src/factories/gameboard.js\");\n/* harmony import */ var _dom_utils_displayBoard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom_utils/displayBoard */ \"./src/dom_utils/displayBoard.js\");\n/* harmony import */ var _utils_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/util */ \"./src/utils/util.js\");\n/* harmony import */ var _dom_utils_createGamePage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dom_utils/createGamePage */ \"./src/dom_utils/createGamePage.js\");\n/* harmony import */ var _dom_utils_displayBoards__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dom_utils/displayBoards */ \"./src/dom_utils/displayBoards.js\");\n/* eslint-disable no-use-before-define */\n/* eslint-disable no-shadow */\n\n\n\n\n\n\nvar player = new _factories_player__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('player');\nvar board = new _factories_gameboard__WEBPACK_IMPORTED_MODULE_1__[\"default\"](player.name, 10);\nvar cpu = new _factories_player__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('computer');\nvar cpuBoard = new _factories_gameboard__WEBPACK_IMPORTED_MODULE_1__[\"default\"](player.name, 10);\ncpuBoard.ships = cpu.fleet;\ncpuBoard.placeRandom(cpu.fleet);\ncpu.fleet = [];\nvar playerTurn = true;\nvar gameOver = false;\nconsole.log(cpu.fleet, cpuBoard);\nfunction app() {\n  if (!player.fleet.length) {\n    (0,_dom_utils_createGamePage__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n    (0,_dom_utils_displayBoards__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(player, board);\n    (0,_dom_utils_displayBoards__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(cpu, cpuBoard);\n    addClickEvent();\n    gameLoop(player, board, cpu, cpuBoard);\n  } else {\n    (0,_dom_utils_displayBoard__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(player, board);\n    (0,_utils_util__WEBPACK_IMPORTED_MODULE_3__.clckHandler)(app);\n  }\n}\nfunction addClickEvent() {\n  var cells = document.querySelectorAll('#cell-computer');\n  cells.forEach(function (cell) {\n    cell.addEventListener('click', function () {\n      if (playerTurn && !gameOver) {\n        var row = cell.getAttribute('data-row');\n        var col = cell.getAttribute('data-col');\n        if (cpuBoard.hits.has(\"\".concat(row, \",\").concat(col))) {\n          console.log('invalid move');\n          playerTurn = true;\n          return;\n        }\n        cell.style.background = 'purple';\n        var x = cpuBoard.receveAttack(Number(row), Number(col));\n        if (x) {\n          cell.style.background = 'green';\n          console.log('enemy is hit');\n          console.log(cpuBoard.ships);\n        }\n        if (cpuBoard.allShipsSunk() || board.allShipsSunk()) {\n          gameOver = true;\n        }\n        playerTurn = false;\n      }\n    });\n  });\n}\nfunction cpuAttack(board) {\n  // Implement your CPU attack logic here\n  // For example, randomly select a cell to attack\n  var randomRow = Math.floor(Math.random() * 10);\n  var randomCol = Math.floor(Math.random() * 10);\n\n  // Perform CPU player's attack\n  var result = board.receveAttack(randomRow, randomCol);\n  if (result) {\n    console.log('CPU Player: Hit!');\n  } else {\n    console.log('CPU Player: Miss!');\n  }\n  if (board.allShipsSunk()) {\n    gameOver = true;\n  }\n}\nfunction gameLoop(player, playerBoard, cpu, cpuBoard) {\n  if (gameOver) {\n    var winner = playerBoard.allShipsSunk() ? cpu : player;\n    console.log(\"Game Over! \".concat(winner.name, \" wins!\"));\n    return;\n  }\n  if (cpuBoard.allShipsSunk() || playerBoard.allShipsSunk()) {\n    gameOver = true;\n  }\n  if (!playerTurn) {\n    cpuAttack(playerBoard);\n    (0,_dom_utils_displayBoards__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(player, playerBoard);\n    playerTurn = true;\n  }\n  requestAnimationFrame(function () {\n    return gameLoop(player, playerBoard, cpu, cpuBoard);\n  });\n}\n\n//# sourceURL=webpack://battleship/./src/App.js?");
