...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ app)\n/* harmony export */ });\n/* harmony import */ var _app_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.scss */ \"./src/app.scss\");\n/* harmony import */ var _factories_player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./factories/player */ \"./src/factories/player.js\");\n/* harmony import */ var _factories_gameboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./factories/gameboard */ \"./src/factories/gameboard.js\");\n/* harmony import */ var _modules_displayBoard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/displayBoard */ \"./src/modules/displayBoard.js\");\n/* harmony import */ var _utils_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/util */ \"./src/utils/util.js\");\n/* harmony import */ var _modules_createGamePage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/createGamePage */ \"./src/modules/createGamePage.js\");\n/* harmony import */ var _modules_displayBoards__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/displayBoards */ \"./src/modules/displayBoards.js\");\n/* harmony import */ var _components_components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/components */ \"./src/components/components.js\");\n/* eslint-disable no-use-before-define */\n/* eslint-disable no-shadow */\n\n\n\n\n\n\n\n\nvar player = new _factories_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('player');\nvar board = new _factories_gameboard__WEBPACK_IMPORTED_MODULE_2__[\"default\"](player.name, 10);\nvar cpu = new _factories_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('computer');\nvar cpuBoard = new _factories_gameboard__WEBPACK_IMPORTED_MODULE_2__[\"default\"](player.name, 10);\ncpuBoard.ships = cpu.fleet;\ncpuBoard.placeRandom(cpu.fleet);\ncpu.fleet = [];\nvar playerTurn = true;\nvar gameOver = false;\nfunction app() {\n  if (!player.fleet.length) {\n    (0,_modules_createGamePage__WEBPACK_IMPORTED_MODULE_5__[\"default\"])();\n    (0,_modules_displayBoards__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(player, board);\n    (0,_modules_displayBoards__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(cpu, cpuBoard);\n    playerAttack();\n    gameLoop(player, board, cpu, cpuBoard);\n  } else {\n    (0,_modules_displayBoard__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(player, board);\n    // re-render setup screen after each cell click\n    (0,_utils_util__WEBPACK_IMPORTED_MODULE_4__.clckHandler)(app);\n  }\n}\nfunction playerAttack() {\n  var cells = document.querySelectorAll('#cell-computer');\n  cells.forEach(function (cell) {\n    cell.addEventListener('click', function () {\n      if (playerTurn && !gameOver) {\n        var row = cell.getAttribute('data-row');\n        var col = cell.getAttribute('data-col');\n        if (cpuBoard.hits.has(\"\".concat(row, \",\").concat(col))) {\n          playerTurn = true;\n          return;\n        }\n        if (!result) {\n          cell.classList.add('player-miss');\n          (0,_components_components__WEBPACK_IMPORTED_MODULE_7__.displayMessage)('we missed them');\n        }\n        var result = cpuBoard.receveAttack(Number(row), Number(col));\n        if (result) {\n          var shipsLeft = cpuBoard.ships.filter(function (ship) {\n            return ship.isSunk === false;\n          });\n          cell.classList.add('hit');\n          (0,_components_components__WEBPACK_IMPORTED_MODULE_7__.displayMessage)(\"we hit them, they have  \".concat(shipsLeft.length, \" more ships\"));\n        }\n        if (cpuBoard.allShipsSunk() || board.allShipsSunk()) {\n          gameOver = true;\n          (0,_components_components__WEBPACK_IMPORTED_MODULE_7__.removeMessage)();\n        }\n        playerTurn = false;\n      }\n    });\n  });\n}\nfunction cpuAttack(board) {\n  var result = board.randomHit();\n  var message;\n  result ? message = 'CPU Player: Hit!' : message = 'CPU Player: Miss!';\n  setTimeout(function () {\n    (0,_components_components__WEBPACK_IMPORTED_MODULE_7__.displayMessage)(message);\n  }, 500);\n  board.allShipsSunk() ? gameOver = true : gameOver = false;\n}\nfunction gameLoop(player, playerBoard, cpu, cpuBoard) {\n  if (gameOver) {\n    var winner = playerBoard.allShipsSunk() ? cpu : player;\n    var message = \"Game Over! \".concat(winner.name, \" wins!\");\n    (0,_components_components__WEBPACK_IMPORTED_MODULE_7__.displayModal)(resetGame, message);\n    return;\n  }\n  if (cpuBoard.allShipsSunk() || playerBoard.allShipsSunk()) {\n    gameOver = true;\n  }\n  if (!playerTurn) {\n    cpuAttack(playerBoard);\n    (0,_modules_displayBoards__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(player, playerBoard);\n    playerTurn = true;\n  }\n  setTimeout(function () {\n    return gameLoop(player, playerBoard, cpu, cpuBoard);\n  }, 0);\n}\nfunction resetGame() {\n  // Reset the game state variables\n  player = new _factories_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('player');\n  board = new _factories_gameboard__WEBPACK_IMPORTED_MODULE_2__[\"default\"](player.name, 10);\n  cpu = new _factories_player__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('computer');\n  cpuBoard = new _factories_gameboard__WEBPACK_IMPORTED_MODULE_2__[\"default\"](player.name, 10);\n  cpuBoard.ships = cpu.fleet;\n  cpuBoard.placeRandom(cpu.fleet);\n  cpu.fleet = [];\n  playerTurn = true;\n  gameOver = false;\n  (0,_components_components__WEBPACK_IMPORTED_MODULE_7__.removeMessage)();\n  app();\n}\n\n//# sourceURL=webpack://battleship/./src/App.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   displayMessage: () => (/* binding */ displayMessage),\n/* harmony export */   displayModal: () => (/* binding */ displayModal),\n/* harmony export */   removeMessage: () => (/* binding */ removeMessage)\n/* harmony export */ });\n/* harmony import */ var _utils_createHtml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/createHtml */ \"./src/utils/createHtml.js\");\n\nfunction displayMessage(message) {\n  var popup = document.querySelector('.player-popup');\n  popup.textContent = message;\n  popup.classList.add('show-popup');\n}\nfunction removeMessage() {\n  var popup = document.querySelector('.player-popup');\n  popup.classList.remove('show-popup');\n}\nfunction displayModal(cb, message) {\n  var body = document.querySelector('body');\n  var modalContainer = (0,_utils_createHtml__WEBPACK_IMPORTED_MODULE_0__.createHtml)('div', 'modal-container');\n  var modal = (0,_utils_createHtml__WEBPACK_IMPORTED_MODULE_0__.createHtml)('div', 'modal');\n  var modaltext = (0,_utils_createHtml__WEBPACK_IMPORTED_MODULE_0__.createHtml)('h3', 'modal-text');\n  var modalBtn = (0,_utils_createHtml__WEBPACK_IMPORTED_MODULE_0__.createHtml)('button', 'modal-btn');\n  modalBtn.textContent = 'restart game';\n  body.appendChild(modalContainer);\n  modalContainer.appendChild(modal);\n  modalBtn.addEventListener('click', function () {\n    cb();\n    (0,_utils_createHtml__WEBPACK_IMPORTED_MODULE_0__.clearHtml)(modalContainer);\n    body.removeChild(modalContainer);\n  });\n  modal.appendChild(modaltext);\n  modal.appendChild(modalBtn);\n  modaltext.textContent = message;\n}\n\n\n//# sourceURL=webpack://battleship/./src/components/components.js?");
...
/***/ "./src/utils/updateStyles.js":
/*!***********************************!*\
  !*** ./src/utils/updateStyles.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ updateStyles)\n/* harmony export */ });\nfunction updateStyles(cell, board, player, row, col) {\n  if (board.gameboard[row][col] !== 0 && player.name === 'player') {\n    cell.classList.add('taken');\n  }\n  if (board.hits.has(\"\".concat(row, \",\").concat(col)) && board.gameboard[row][col] !== 0) {\n    cell.classList.add('hit');\n  }\n  if (board.hits.has(\"\".concat(row, \",\").concat(col)) && board.gameboard[row][col] === 0) {\n    cell.classList.add('cpu-miss');\n  }\n}\n\n//# sourceURL=webpack://battleship/./src/utils/updateStyles.js?");
